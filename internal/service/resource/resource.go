...
type IResourceService interface {
	...
	SyncMenus(ctx context.Context, service string, menus domain.MenuTree) error
...
func (s *resourceService) SyncMenus(ctx context.Context, service string, menus domain.MenuTree) error {
	return s.repo.SyncMenus(ctx, service, menus.Flatten(service))
}
